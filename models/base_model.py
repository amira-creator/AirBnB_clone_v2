#!/usr/bin/python3
"""This module defines base class for all models in HBNB clone"""
...
class BaseModel:
    ...
    def __str__(self):
        """It eturns string representation of instance"""
        return "[{:s}] ({:s}) {}".format(self.__class__.__name__, self.id,
                                         self.__dict__)

    def save(self):
        """It Updates updated_at with current time when instance changed"""
    ...
    def delete(self):
        """Function deletes current instance from storage"""
